...
class MY_Router extends MX_Router {
	/* Found on : https://github.com/PhiloNL/CodeIgniter-Route-Debugging/blob/master/MY_Router.php
	 * ===> Parse_routes doesn't belong to MX_Router or HMVC, i just adapted it*/
	/**
	 *  Parse Routes
	 *
