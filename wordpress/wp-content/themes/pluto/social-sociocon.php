<div id="social_icons">
            ...
            <?php if ( of_get_option('twitter', true) != "") { ?>
			 <a target="_blank" href="http://twitter.com/<?php echo esc_url(of_get_option('twitter', true)); ?>" title="<?php esc_attr_e( 'Twitter', 'pluto' ); ?>" ><img src="<?php echo get_template_directory_uri()."/images/twitter.png"; ?>"></a>
             <?php } ?>
