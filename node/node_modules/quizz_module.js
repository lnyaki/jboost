		...
		var events_handling			= function(){
			...
			io.sockets.on('connection',function(socket){
				...
				socket.on('love',function(message){
					socket.emit("message", "love you too babe!");
				});
				...
				//Create new user
				socket.on(NEW_USER,function(username,lobby){
					console.log("LOBBIES :");
					console.log(toto.lobbies);
					console.log(toto.rooms);
					//console.log(this);
					toto.lobbies[lobby].add_player(username);
