...
module.exports = function(){
	...
	Game.prototype 		= function(){
		...
		//if the player doesn't already exist, add him		
			if(this.player_list[player.reference] == undefined){
				this.layer_list[player.reference] = player;
			}
			else{
		...
		var add_spectator		= function(spectator){
			...
			if(this.spectator_list[spectator.reference] == undefined){
				this.spectator_list[spectator.reference] = spectator;
			}
			else{
		...
		var remove_player		= function(player){
			this.player_list[player.reference] = null;
		};
		
		//remove a spectator from the spectator list
		var remove_spectator	= function(spectator){
			this.spectator_list[spectator.reference] = null;
		};
